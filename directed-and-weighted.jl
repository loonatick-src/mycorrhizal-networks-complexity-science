...
# ╔═╡ 5fcfcca5-b131-4427-a83d-c2ba26b7cce1
using NetworkDynamics

# ╔═╡ 114d17ce-e2c3-417c-a41d-338fba88a2b6
using OrdinaryDiffEq

# ╔═╡ f30d2990-0935-4728-8e61-b5e67d83320d
using Plots

# ╔═╡ 50cb2fc2-f162-11ec-24b8-310a0261ccac
md"
# Neurodynamic model of synchronization in the human brain
Spiking neurons, bitch.
...
# ╔═╡ c913d6e8-b1e1-4a1b-80e8-32cda8c47dda
begin
	g_weighted = SimpleWeightedDiGraph(G)

	edge_weights = getfield.(collect(edges(g_weighted)), :weight)

	# promote to directed graph
	g_directed = SimpleDiGraph(g_weighted);
end

# ╔═╡ d2a40808-15c0-4a4d-915b-36ae3c842bb3
md"
Again, define the vertex and edge functions."

# ╔═╡ 9f2552b2-9481-44a1-82cc-280e7d2a9364
Base.@propagate_inbounds function electrical_edge!(e, v_s, v_d, p, t)
	e[1] = p * (v_s[1] - v_d[1]) # * σ
	nothing
end

# ╔═╡ 5f628c3e-0a40-4b3d-b3cb-13db326b08a0
md"
# Parameter Handling
What is this now?
"

# ╔═╡ 97eed8f6-ad25-44ab-aa71-35990dfcd9eb
begin
	N = 90
	const ϵ = 0.05
	const a = 0.5
...
# ╔═╡ 1a9ab0ec-bbc9-4cf5-b2d2-cf025449c64c
...
# ╔═╡ 33ab560b-ac25-4cf6-94db-2db73b5536d3
begin
	ode_el_vertex = ODEVertex(; f=fhn_electrical_vertex!, dim=2, sym=[:u, :v]);
	electrical_edge = StaticEdge(; f=electrical_edge!, dim=1, coupling=:directed)
	fhn_network! = network_dynamics(ode_el_vertex, electrical_edge, g_directed)
end

# ╔═╡ 6a12823e-1137-402c-ab3b-50506354b794
md"
### Important
When `p` is an array, the entire arrays is passed to each `VertexFunction` and `EdgeFunction`. When `p` is a tuple of two arrays with lengths corresponding to the number of nodes and the number of edges respectively, then `network_dynamics` passes only the edge or node parameters with the index of the edge or node. When there are no parameters for either edges or nodes the value `nothing` may be used."

# ╔═╡ b1133e5f-ff7a-44bf-a76f-4c0c2779e12f
begin
	tspan = (0.0, 200.0)
...
# ╔═╡ e340a950-d4af-4a28-8cdf-751b93696b10
